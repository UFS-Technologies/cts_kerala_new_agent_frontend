...
this.myTotalHeight=this.myTotalHeight-700;
this.Clr_Experience();
...
Save_Experience()
{
    if (this.Experience_.Experience_Name== undefined || this.Experience_.Experience_Name == null || this.Experience_.Experience_Name == "" ) 
    {
        const dialogRef = this.dialogBox.open(DialogBox_Component, { panelClass: 'Dialogbox-Class', data: { Message: 'Enter Experience', Type: "3" } });
        return;
    }
